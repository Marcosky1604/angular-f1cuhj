...
@Component({
  selector: 'app-exercice-interpolation',
  templateUrl: './exercice-interpolation.component.html',
  styleUrls: ['./exercice-interpolation.component.css'],
})
export class ExerciceInterpolationComponent implements OnInit {
  message: string = 'coucou';
  constructor(private messageService: MessageService) {}
  //constructor() {}
  ngOnInit() {
    //this.messageService.afficherMessage(this.message);
  }
  ...
  prenom = 'Marc';
  lien = 'www.google.fr';
  monChamp = 'Saisir quelque chose ici ...';
  imgGoogle =
  ...
  trackByFn(index: number, fruit: any) {
    return fruit.id;
  }
}
